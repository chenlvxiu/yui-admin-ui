  ...
  <main class="site-content" :class="{ 'site-content--tabs': $route.meta.isTab }">
    ...
    <el-tabs
      ...
      <div class="site-tabs__tools">
        <el-dropdown :show-timeout="0" :hide-on-click="false" autofocus style="margin-right: 10px;" v-show="isShow">
  ...
  export default {
    ...
    computed: {
      ...
      textarea: {
        ...
        set(val) {
          this.$store.commit('user/updateExplain', val)
        }
      },
      isShow() {
        return this.$route.name == 'juryReview-user'
      }
    },
    methods: {
      // tabs, 选中tab
