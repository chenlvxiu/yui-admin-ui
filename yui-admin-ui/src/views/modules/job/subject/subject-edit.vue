<template>
  <el-dialog :title="!id ? '新增' : '修改'"  class="mod-subject-edit"
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-row :gutter="20">
        ...
        <el-col :span="11">
          <el-form-item label="学术团队名称" prop="teamName">
            <el-input v-model="dataForm.teamName" placeholder="学术团队名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="任何种职务" prop="duty">
            <el-input v-model="dataForm.duty" placeholder="任何种职务"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          teamName: [
            { required: true, message: '学术团队名称不能为空', trigger: 'blur' }
          ],
          duty: [
            { required: true, message: '任何种职务不能为空', trigger: 'blur' }
          ],
          catCd: [
    ...
    methods: {
      ...
      dataFormSubmit: debounce(function () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            let url = !this.id ? '/job/subject/add' : '/job/subject/upd'
