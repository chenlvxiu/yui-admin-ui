<template>
  <el-dialog :title="!id ? '新增' : '修改'"  class="mod-study-edit"
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-row :gutter="20">
        ...
        <el-col :span="11">
          <el-form-item label="专业或主要内容" prop="content">
            <el-input v-model="dataForm.content" placeholder="专业或主要内容"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="主办单位" prop="unit">
            <el-input v-model="dataForm.unit" placeholder="主办单位"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
...
<script>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          ...
          content: [
            { required: true, message: '专业或主要内容不能为空', trigger: 'blur' }
          ],
          unit: [
    ...
    methods: {
      ...
      // 获取职称申报系统-人员职称申报学习培训经历表信息
      getInfo () {
        this.$http.get('/job/study/info/' + this.id).then(({data: res}) => {
          if (res.code !== 0) {
      ...
      dataFormSubmit: debounce(function () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            let url = !this.id ? '/job/study/add' : '/job/study/upd'
