<template>
  <el-dialog :title="!id ? '新增' : '修改'"  class="mod-jury-edit"
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-row :gutter="20">
        ...
        <el-col :span="11">
          <el-form-item label="主管部门账号id" prop="userId">
            <el-input v-model="dataForm.userId" placeholder="主管部门账号id"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="主管部门账号" prop="username">
            <el-input v-model="dataForm.username" placeholder="主管部门账号"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          userId: [
            { required: true, message: '主管部门账号id不能为空', trigger: 'blur' }
          ],
          username: [
            { required: true, message: '主管部门账号不能为空', trigger: 'blur' }
          ],
          name: [
    ...
    methods: {
      ...
      dataFormSubmit: debounce(function () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            let url = !this.id ? '/job/jury/add' : '/job/jury/upd'
