<template>
  <el-dialog :title="!id ? '新增' : '修改'"  class="mod-eduRec-edit"
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-row :gutter="20">
        ...
        <el-col :span="11">
          <el-form-item label="" prop="eduId">
            <el-input v-model="dataForm.eduId" placeholder=""></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
        ...
        <el-col :span="11">
          <el-form-item label="组织单位" prop="unit">
            <el-input v-model="dataForm.unit" placeholder="组织单位"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="学习情况" prop="studyDec">
            <el-input v-model="dataForm.studyDec" placeholder="学习情况"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          studyDec: [
            { required: true, message: '学习情况不能为空', trigger: 'blur' }
          ],
          catCd: [
    ...
    methods: {
      ...
      dataFormSubmit: debounce(function () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            let url = !this.id ? '/job/eduRec/add' : '/job/eduRec/upd'
