<template>
  <el-dialog :title="!id ? '新增' : '修改'"  class="mod-sms-edit"
      ...
      <el-row :gutter="22">
        ...
        <el-col :span="11">
          <el-form-item label="类型" prop="catCd">
            <el-radio-group v-model="dataForm.catCd">
              <el-radio label="20030.150">验证码</el-radio>
              <el-radio label="20030.160">短信通知</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
        <el-col :span="11">
      ...
      <el-row :gutter="20">
        <el-col :span="22">
          <el-form-item label="内容" prop="cont">
            <el-input type="textarea" v-model="dataForm.cont" placeholder="内容"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    methods: {
      ...
      dataFormSubmit: debounce(function () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            let url = !this.id ? '/sys/sms/add' : '/sys/sms/upd'
