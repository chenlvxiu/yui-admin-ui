<template>
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="listData()">
      ...
      <el-form-item>
        <el-input v-model="dataForm.mob" placeholder="手机" clearable></el-input>
      </el-form-item>
      <el-form-item>
        ...
        <!-- <el-button v-if="$hasPerm('sys:user:expt')" size="small" @click="exptHandle()">导出</el-button>
        <el-button v-if="$hasPerm('sys:user:impt')" size="small" @click="imptHandle()">导入</el-button> -->
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border stripe v-loading="dataListLoading" :max-height="tableHeight" 
      ...
      <el-table-column prop="mob" label="手机" sortable="custom" header-align="center" align="center"></el-table-column>
      ...
      <el-table-column prop="crtTm" label="创建时间" sortable="custom" header-align="center" align="center"></el-table-column>
