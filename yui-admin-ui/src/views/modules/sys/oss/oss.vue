<template>
  <div class="mod-oss">
    ...
    <el-table :data="dataList" border stripe v-loading="dataListLoading" :max-height="tableHeight" 
            :default-sort = "{prop: 'tm', order: 'descending'}"
            @selection-change="selectionChangeHandle" @sort-change="sortChangeHandle" style="width: 100%;">
      <el-table-column type="selection" header-align="center" align="center" width="50"></el-table-column>
      <el-table-column prop="origNm" label="原文件名称" sortable="custom" header-align="center" align="center" width="250"></el-table-column>
      <!-- <el-table-column prop="storNm" label="存储名称" sortable="custom" header-align="center" align="center"></el-table-column> -->
      <el-table-column prop="url" label="存储地址" sortable="custom" header-align="center" align="center">
        <template slot-scope="scope">
          <filePreview :files="scope.row.url" :imageShow=true></filePreview>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="tm" label="上传时间" sortable="custom" header-align="center" align="center" width="160"></el-table-column>
      <!-- <el-table-column prop="type" label="类型" sortable="custom" header-align="center" align="center"></el-table-column> -->
