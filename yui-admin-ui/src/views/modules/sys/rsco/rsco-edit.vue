<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-row :gutter="20">
        <el-col :span="11">
          <el-form-item label="类型" prop="catCd">
            <el-radio-group v-model="dataForm.catCd" :disabled="id > 0">
              <el-radio label="20010.160">菜单</el-radio>
              <el-radio label="20010.170">功能</el-radio>
              <el-radio label="20010.165">伪菜单</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
        <el-col :span="11">
        ...
        <el-col :span="22">
          <el-form-item v-if="dataForm.catCd === '20010.160'" label="资源路径" prop="url">
            <el-input v-model="dataForm.url" placeholder="资源路径"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="22" v-if="dataForm.catCd !== '20010.165'">
          <el-form-item label="权限标识" prop="perm">
            <el-input v-model="dataForm.perm" placeholder="权限标识"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11" v-if="dataForm.catCd === '20010.160'">
          <el-form-item v-if="dataForm.catCd === '20010.160'" prop="icon" label="图标" class="icon-list">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 获取菜单列表
      listMenu () {
        return this.$http.get('/sys/rsco/listMenuTree').then(({ data: res }) => {
          if (res.code !== 0) {
      ...
      dataFormSubmit: debounce(function () {
        ...
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            let url = !this.id ? '/sys/rsco/add' : '/sys/rsco/upd'
