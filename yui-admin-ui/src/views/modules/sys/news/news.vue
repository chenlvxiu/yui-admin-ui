<template>
  <div class="mod-news">
    ...
    <el-table :data="dataList" border stripe v-loading="dataListLoading" :max-height="tableHeight" 
      ...
      <el-table-column prop="rcdTm" label="记录时间" sortable="custom" header-align="center" align="center" width="150"></el-table-column>
      <el-table-column prop="releTm" label="发布时间" sortable="custom" header-align="center" align="center" width="150"></el-table-column>
