<template>
  <div class="mod-smsLog">
    ...
    <el-table :data="dataList" border stripe v-loading="dataListLoading" :max-height="tableHeight" 
            :default-sort = "{prop: 'sendTm', order: 'descending'}"
      ...
      <el-table-column prop="statNm" label="状态" sortable="custom" header-align="center" align="center" width="150"></el-table-column>
